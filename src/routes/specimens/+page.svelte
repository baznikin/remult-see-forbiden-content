<script lang="ts">
  ...
  // get the repo
  const specimenRepo = repo(Specimen)
...
<form on:submit|preventDefault={add}>
  ...
  {#if validationError?.collection_id}
    <span>{validationError.collection_id}</span>
  {/if}
  ...
  {#if validationError?.collection_location}
    <span>{validationError.collection_location}</span>
  {/if}
  ...
  {#if validationError?.collection_conditions}
    <span>{validationError.collection_conditions}</span>
  {/if}
  ...
  {#if validationError?.collection_date}
    <span>{validationError.collection_date}</span>
  {/if}
  ...
  {#if validationError?.collection_collector}
    <span>{validationError.collection_collector}</span>
  {/if}
  ...
  {#if validationError?.development_stage}
    <span>{validationError.development_stage}</span>
  {/if}
  ...
  {#if validationError?.storage_location}
    <span>{validationError.storage_location}</span>
  {/if}
  ...
  {#if validationError?.metrics_winglength}
    <span>{validationError.metrics_winglength}</span>
  {/if}
  ...
  {#if validationError?.metrics_wingspan}
    <span>{validationError.metrics_wingspan}</span>
  {/if}
